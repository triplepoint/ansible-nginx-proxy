# Ansible Nginx Proxy [![Build Status](https://travis-ci.org/triplepoint/ansible-nginx-proxy.svg?branch=master)](https://travis-ci.org/triplepoint/ansible-nginx-proxy)
A deployment role for the [Nginx proxy developed by Jason Wilder](https://github.com/jwilder/nginx-proxy).
